#include <glm/glm.hpp>
#include "Entity.h"
Entity::Entity(EntityType _type, unsigned char _color[4], float _is_moveable, float _is_destructable, 
          ...
          float _conductivity, float _melting_pt, float _boiling_pt, glm::vec2 _velocity, 
...
Entity::Entity() : type(EntityType::CUSTOM), color{255, 0, 0, 255}, is_moveable(true), is_destructable(true),
                   ...
                   c_strength(1), elasticity(1), friction(0), temperature(273),
                   conductivity(1), melting_pt(273), boiling_pt(373), velocity(0.0f, 0.0f),
